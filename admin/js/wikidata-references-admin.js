...
function wkrf_modal_create_list(tag_term, wikidata_search, input_id){
	...
	//if first elem of array is null, its empty, so We will show a message of empty search.
	//(el buen hardcode) 
...
function wkrf_modal_add_message(message){
	...
	wkrf_modal_window_content.innerHTML +=
		'<div id="wkrf_modal_window_message" class="wkrf_modal_window_message col-md-12">'+message+'</div>';
}
/*

...
class Wikidata_References {
	...
	private function define_public_hooks() {
		...
		//require_once plugin_dir_path( dirname(__FILE__ ) ) . 'includes/class-wikidata-references-metabox.php';
		//$this->loader->add_action('add_meta_boxes', 'wkrf_add_wiki_reference_meta_box', 10, 2);
		//$this->loader->add_action('add_meta_boxes', $plugin_public, 'wkrf_add_wiki_reference_meta_box', 10, 2);
		//$this->loader->add_action('add_meta_boxes', $metabox, 'wkrf_add_wiki_reference_meta_box', 10, 2);
		//require_once plugin_dir_path( dirname(__FILE__ ) ) . 'includes/class-wikidata-references-metabox.php';
		////$this->loader->add_action('add_meta_boxes', 'wkrf_add_wiki_reference_meta_box', 10, 2);
		//$this->loader->add_action('save_post', $metabox, 'wkrf_render_wiki_references_meta_box', 10, 2);
		//$this->loader->add
